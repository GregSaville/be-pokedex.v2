...
class WelcomeController {
    ...
    val welcomeHTML = "<h1>Welcome to the Pokedex API</h1>" +
            " <h2>---Public Endpoints---</h2> <h4>/welcome</h4> <h4>/api/pokemon</h4>   <h4>/api/pokemon/{pokemon id}</h4> <h4>/api/pokemon/?name={pokemon's name}</h4> <h4>/api/pokemon/?type={type1,type2}  || ?type={type1 type2}</h4> <h2>---Authenticated Endpoints---</h2> <h4>/api/trainers</h4>  <h4>/api/trainers/{trainer id}</h4> <h4>/api/trainers/?name={trainer's name}</h4> <h4>/api/trainers/{trainers id}/captured</h4>" +
